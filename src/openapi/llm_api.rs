...
impl OpenAI {
    pub fn new(endpoint: &str) -> Result<Self, BotError> {
        let client = Client::new();
        let base_url = format!("https://api.openai.com/v1/{}", endpoint);
        Ok(Self {
    ...
    pub async fn embeddings(&self, image_description: &str) -> Result<(), BotError> {
